...
tape('service1 parse', function (t) {
  t.same(schema.parse(fixture('service1.proto')), require('./fixtures/service.json'))
  t.end()
})

tape('service1 parse + stringify', function (t) {
  var syntax = 'syntax = "proto3";\n\n'
  t.same(schema.stringify(schema.parse(fixture('service1.proto'))), syntax + fixture('service1.proto'))
  t.end()
})
